...
package Test.Instrument is
   procedure Process_Source (The_Unit : Analysis_Unit);

   Instrumentation_Error : exception;
   --  Indicates that an unhandled error occured during the processing of given
   --  unit and instrumented source has not being generated partially
   --  or completely and thus is unusable.
end Test.Instrument;
