   ...
   begin
      ...
      for Subp of Subps loop
         declare
            ...
            Params         : Component_Map renames Fun_Typ.Component_Types;
            Param_Cur      : Component_Maps.Cursor;
            Ordered_Params : String_Vectors.Vector renames Fun_Typ.Param_Order;
            Globals        : Component_Map renames Fun_Typ.Globals;
         begin
            ...
            Assocs.Insert
              (Assoc
                 ("TC_NAME",
                  Unbounded_String'
                    ((if Is_Operator (Fun_Typ.Simple_Name)
                      then Map_Operator_Name (Fun_Typ.Simple_Name)
                      else Fun_Typ.Simple_Name)
                     & "-"
                     & Fun_Typ.Long_UID)));
            Assocs.Insert
              (Assoc
