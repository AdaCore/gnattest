...
package TGen.Types.Array_Types is
   ...
   function Supports_Static_Gen (Self : Array_Typ) return Boolean
   is (Self.Static_Gen);
   ...
   function Kind (Self : Constrained_Array_Typ) return Typ_Kind
   is (Constrained_Array_Kind);
   ...
   function Make_Unconst_Array_Enum_Strat
     (Arr_T : Unconstrained_Array_Typ; Sizes : Nat_Array)
      return Unconst_Array_Enum_Strat'Class;
