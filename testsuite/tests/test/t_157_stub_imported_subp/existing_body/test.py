...
# Since there is already a body with a normally stub-able function in it,
# there should be a stub body, but no spec file ?
thistest.fail_if(not BODY_STUB.exists(), "missing expected body stub")
