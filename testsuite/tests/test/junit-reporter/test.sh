...
gnattest -P tagged_rec.gpr -q --harness-dir=h1 --reporter=junit --separate-drivers=unit
gprbuild -q -P h1/test_drivers.gpr
h1/P.T_Test_Data.T_Tests/p-t_test_data-t_tests-suite-test_runner
echo "Driver per test:"
gnattest -P tagged_rec.gpr -q --harness-dir=h2 --reporter=junit --separate-drivers=test --validate-type-extensions --source-root=gnattest
...
gnattest -P tagged_rec.gpr -q --harness-dir=h3 --reporter=junit --stub
gprbuild -q -P h3/test_drivers.gpr
h3/P.T_Test_Data.T_Tests/p-t_test_data-t_tests-suite-test_runner
echo "Driver file path relative (stubbing):"
gnattest -P tagged_rec.gpr -q --harness-dir=h4 --reporter=junit --source-root=gnattest_stub --stub
gprbuild -q -P h4/test_drivers.gpr
h4/P.T_Test_Data.T_Tests/p-t_test_data-t_tests-suite-test_runner
