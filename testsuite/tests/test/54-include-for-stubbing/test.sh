...
gnattest --tests-dir=test_scenario_1 -P p --stub --skeleton-default=pass --include-for-stubbing=global_list.txt --include-for-stubbing=a.ads:a_list.txt
...
gnattest --tests-dir=test_scenario_3 -P p --stub --skeleton-default=pass --include-for-stubbing=global_list.txt --exclude-from-stubbing=a.ads:global_list.txt
gprbuild -Pgnattest_stub/harness/test_drivers.gpr -q -gnatws
gnattest gnattest_stub/harness/test_drivers.list --passed-tests=hide
